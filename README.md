...
This module exports the related types for commonly used schema types. You will be able to distinguish between what is [documented](https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data) as working for structured data markup by Google, but no limited.
<br>
